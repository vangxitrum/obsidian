...
On 2026-08-22 the product direction shifted to make a no-install public website the acquisition surface. It should answer intent-rich questions such as what gift to buy for a loved one and explain gifts users are considering, then link to approved merchants through clearly disclosed official affiliate links such as Shopee's. The mobile app remains the retention surface for saved people, occasions, reminders, and notifications.
